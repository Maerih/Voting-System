...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference("Contestant.count") do
      post contestants_url, params: { contestant: { email: @contestant.email, name: @contestant.name, number_of_votes: @contestant.number_of_votes, user_id: @contestant.user_id } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { email: @contestant.email, name: @contestant.name, number_of_votes: @contestant.number_of_votes, user_id: @contestant.user_id } }
